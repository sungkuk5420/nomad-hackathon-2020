    ...
    >
      ...
      >
        ...
        <div
          ...
          :style="{ backgroundImage: `url('${imagePath(item.mainImage)}')` }"
          slot="cover"
        ></div>
        ...
        <div class="avatar">
          ...
          <img
            ...
            :src="imagePath(item.firstPeopleImage)"
          ...
          <img
            ...
            :src="imagePath(item.secondPeopleImage)"
            class="ant-avatar ant-avatar-lg ant-avatar-circle ant-avatar-icon"
          />
        </div>
  ...
  watch: {
    teamCards(cards) {
      if (cards.length > 0) {
        ...
        console.log(this.teamCardsFilter)
      } else {
        this.loading = false;
      }
    }
